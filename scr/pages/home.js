...
export function managePotsButton_click(event) {
	...
	let generatedURL = "/pot-manager?load=sort&locationto=home&bills=" + billsPotAmount + "&subscriptions=" + subscriptionsPotAmount + "&manualsubscriptions=" + manualsubscriptionsPotAmount + "&prefillbills=" + Bills + "&prefillsubscriptions=" + Subscriptions + "&prefillmanualsubscriptions=" + ManualSubscriptions + "&authCode=KW3862";
